-- Deprecated tmux-specific config kept for reference; replaced by vim-slime.lua.
-- Returning an empty spec so this file does not affect plugin loading.
return {}

--[[ Original config (kept for reference only):
return {
  "jpalardy/vim-slime",
  ft = { "python" },
  keys = {
